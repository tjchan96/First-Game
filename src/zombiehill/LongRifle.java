...
public class LongRifle extends GenericWeapon
{
    ...
    public void paintSelf(Graphics2D g2, Point playerPoint, Color color)
    {
        ...
        {
            firingPoint = new Point((int) ((holder.unitPoint.x + holder.unitWidth / 2 - 35) + 100 * Math.cos(Math.toRadians(getDirectionToTarget()))), (int) ((holder.unitPoint.y + holder.unitHeight / 2 - 40) + 100 * Math.sin(Math.toRadians(getDirectionToTarget()))));
        } else
        {
            firingPoint = new Point((int) ((holder.unitPoint.x + holder.unitWidth / 2 + 35) + 100 * Math.cos(Math.toRadians(getDirectionToTarget()))), (int) ((holder.unitPoint.y + holder.unitHeight / 2 - 40) + 100 * Math.sin(Math.toRadians(getDirectionToTarget()))));
        }
