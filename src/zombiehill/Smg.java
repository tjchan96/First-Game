...
public class Smg extends GenericWeapon
{
    ...
    public void paintSelf(Graphics2D g2, Point playerPoint, Color color)
    {
        ...
        firingPoint = new Point((int) ((holder.unitPoint.x + holder.unitWidth / 2) + 80 * Math.cos(Math.toRadians(getDirectionToTarget()))), (int) ((holder.unitPoint.y + holder.unitHeight / 4) + 80 * Math.sin(Math.toRadians(getDirectionToTarget()))));
