...
public class FlameThrower extends GenericWeapon
{
    ...
    public void paintSelf(Graphics2D g2, Point playerPoint, Color color)
    {
        ...
        {
            firingPoint = new Point((int) ((holder.unitPoint.x + holder.unitWidth / 2 - 25) + 130 * Math.cos(Math.toRadians(getDirectionToTarget()))), (int) ((holder.unitPoint.y + holder.unitHeight / 4 - 40) + 120 * Math.sin(Math.toRadians(getDirectionToTarget())) + 20));
        } else
        {
