...
public class Carbine extends GenericWeapon
{
    ...
    public void paintSelf(Graphics2D g2, Point playerPoint, Color color)
    {
        ...
        {
            firingPoint = new Point((int) ((holder.unitPoint.x + holder.unitWidth / 2 - 35) + 70 * Math.cos(Math.toRadians(getDirectionToTarget()))), (int) ((holder.unitPoint.y + holder.unitHeight / 4 - 10) + 80 * Math.sin(Math.toRadians(getDirectionToTarget())) - 20));
        } else
        {
            firingPoint = new Point((int) ((holder.unitPoint.x + holder.unitWidth / 2 + 35) + 70 * Math.cos(Math.toRadians(getDirectionToTarget()))), (int) ((holder.unitPoint.y + holder.unitHeight / 4 - 10) + 80 * Math.sin(Math.toRadians(getDirectionToTarget())) - 20));
        }
