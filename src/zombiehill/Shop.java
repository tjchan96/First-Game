...
public class Shop
{
    ...
    public void paintSelf(Graphics2D g2)
    {
        if (open)
        {
            ...
            hasNuke = false;
            for (int i = 0; i < main.getUnitHolder().getPlayer().weaponList.size(); i++)
            {
                if (main.getUnitHolder().getPlayer().weaponList.get(i) instanceof NukeStrike)
                {
                    hasNuke = true;
                }
            }
    ...
    public void buy(MouseEvent me)
    {
        if (open)
        {
            for (int i = 0; i < weaponRects.size(); i++)
            {
                if (weaponRects.get(i).contains(me.getPoint()) && weaponAvailable.get(i) && (weapons.get(i).requirement == -1 || !weaponAvailable.get(weapons.get(i).requirement)) && main.getUnitHolder().getPlayer().getMoney() - weapons.get(i).getCost() >= -1)
                {
                    ...
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new Magnum(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof Rifle)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new Rifle(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof LongRifle)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new LongRifle(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof SniperRifle)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new SniperRifle(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof Carbine)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new Carbine(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof RangedCarbine)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new RangedCarbine(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof NukeStrike)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new NukeStrike(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof Smg)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new Smg(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof AssaultRifle)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new AssaultRifle(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof Lmg)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new Lmg(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof FlameThrower)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new FlameThrower(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof PumpShotgun)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new PumpShotgun(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof AutoShotgun)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new AutoShotgun(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                    if (weapons.get(i) instanceof GrenadeLauncher)
                    {
                        main.getUnitHolder().getPlayer().weaponList.add(new GrenadeLauncher(main.getUnitHolder().getPlayer(), null, main.getProjectileHolder(), true));
                    }
                } else
                {
                }
