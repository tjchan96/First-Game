...
public class RunnerZombieWeapon extends GenericWeapon
{
    public RunnerZombieWeapon(GenericUnit holder, GenericUnit target, ProjectileHolder projectileHolder, boolean isPlayerWeapon)
    {
