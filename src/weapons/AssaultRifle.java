...
public class AssaultRifle extends GenericWeapon
{
    ...
    public void paintSelf(Graphics2D g2, Point playerPoint, Color color)
    {
        ...
        {
            firingPoint = new Point((int) ((holder.getUnitPoint().x + holder.unitWidth / 2 - 35) + 100 * Math.cos(Math.toRadians(getDirectionToTarget()))), (int) ((holder.getUnitPoint().y + holder.unitHeight / 4 - 10) + 80 * Math.sin(Math.toRadians(getDirectionToTarget())) - 20));
        } else
        {
            firingPoint = new Point((int) ((holder.getUnitPoint().x + holder.unitWidth / 2 + 35) + 100 * Math.cos(Math.toRadians(getDirectionToTarget()))), (int) ((holder.getUnitPoint().y + holder.unitHeight / 4 - 10) + 80 * Math.sin(Math.toRadians(getDirectionToTarget())) - 20));
        }
