...
public class GrenadeLauncher extends GenericWeapon
{
    ...
    public void paintSelf(Graphics2D g2, Point playerPoint, Color color)
    {
        ...
        firingPoint = new Point((int) ((holder.getUnitPoint().x + holder.unitWidth / 2) + 130 * Math.cos(Math.toRadians(getDirectionToTarget()))), (int) ((holder.getUnitPoint().y + holder.unitHeight / 4 - 40) + 120 * Math.sin(Math.toRadians(getDirectionToTarget())) - 20));
