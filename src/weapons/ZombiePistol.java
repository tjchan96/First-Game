...
public class ZombiePistol extends GenericWeapon
{
    ...
    public void paintSelf(Graphics2D g2, Point playerPoint, Color color)
    {
        ...
        firingPoint = new Point((int) ((holder.getUnitPoint().x + holder.unitWidth / 2) + 70 * Math.cos(Math.toRadians(getDirectionToTarget()))), (int) ((holder.getUnitPoint().y + holder.unitHeight / 2) + 70 * Math.sin(Math.toRadians(getDirectionToTarget()))));
