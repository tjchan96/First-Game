...
import projectiles.KnifeProjectile;
...
public class Knife extends GenericWeapon
{
    ...
    public void paintSelf(Graphics2D g2, Point playerPoint, Color color)
    {
        ...
        firingPoint = new Point((int) ((holder.getUnitPoint().x + holder.unitWidth / 2) + 1 * Math.cos(Math.toRadians(getDirectionToTarget()))), (int) ((holder.getUnitPoint().y + holder.unitHeight / 2) + 1 * Math.sin(Math.toRadians(getDirectionToTarget())) - 20));
